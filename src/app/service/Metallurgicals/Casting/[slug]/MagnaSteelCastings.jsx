  ...
  return (
    <div className="bg-white text-gray-800 leading-relaxed">
      ...
      <section className="max-w-6xl mx-auto px-6 py-5">
        ...
        <p>
          Magna Steel Castings are high-performance engineered cast components
          designed to deliver exceptional strength, durability, and wear
          resistance in demanding industrial environments. Manufactured using
          advanced casting processes and premium-quality steel grades, these
          castings ensure reliable performance, dimensional accuracy, and
          extended service life for critical machinery and equipment.
        </p>
      </section>
